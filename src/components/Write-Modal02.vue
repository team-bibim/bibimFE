    ...
    <v-row justify="center">
        <v-dialog v-model="dialog" persistent width="1024">
            <template v-slot:activator="{ props }">
                <v-btn color="#27373E" v-bind="props" class="day-routine-subbox">
                    <v-icon color="white">
                        mdi-plus
                    </v-icon>
                </v-btn>
                    ...
                    <v-container>
                        <v-row>
                            <v-col cols="12" sm="6" md="4">
                                <v-select :items="['0', '1', '2', '3']" label="운동 부위" required></v-select>
                            </v-col>
                            <v-col cols="12" sm="6" md="4">
                                <v-select :items="['0', '1', '2', '3']" label="사용 기구" required></v-select>
                            </v-col>
                            <v-col cols="12" sm="6" md="4">
                            ...
                            <v-col cols="12">
                                ...
                                <v-select :items="['0', '1', '2', '3']" label="운동" required></v-select>
                                <!-- 검색 결과를 여기에 표시 -->
                            </v-col>
